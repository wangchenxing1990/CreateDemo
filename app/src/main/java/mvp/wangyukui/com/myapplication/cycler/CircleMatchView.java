...
public class CircleMatchView extends View {
    ...
    Paint mInPaint;
    Paint mMiddlePaint;
//    Paint mMiddlePaintTwo;
    Paint mOutPaint;
    Paint mMiddleRingPaintTwo;
    ...
    void onAttrs(Context context, AttributeSet attrs) {
        ...
        mMiddleRingPaintTwo = new Paint(Paint.ANTI_ALIAS_FLAG);
        mMiddleRingPaintTwo.setColor(0xff000000);
        mMiddleRingPaintTwo.setStrokeWidth(mCirclePaintWidth);
        mMiddleRingPaintTwo.setStyle(Paint.Style.STROKE);
        mMiddleRingPaintTwo.setStrokeCap(Paint.Cap.ROUND);
        mMiddleRingPaintTwo.setAntiAlias(true);// 消除锯齿
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mOutCircleVisible) {
            ...
            canvas.drawRect(middleRect,mInPaint);
...
//            canvas.drawArc(middleRect, 90,  360, false, mMiddleRingPaintTwo);
